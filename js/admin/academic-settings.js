...
(function() {
    ...
    window.initModule = function(page) {
        ...
        if (page === 'academic-settings') {
            ...
            loadGradingSystem();
            initAcademicSettingsEvents();
        }
    };

    function initAcademicSettingsEvents() {
        const configForm = document.getElementById('academicConfigForm');
        if (configForm) {
            configForm.removeEventListener('submit', handleAcademicConfigSubmit);
            configForm.addEventListener('submit', handleAcademicConfigSubmit);
        }
        
        const gradingForm = document.getElementById('gradingForm');
        if (gradingForm) {
            gradingForm.removeEventListener('submit', handleGradingSubmit);
    ...
    async function handleAcademicConfigSubmit(e) {
        e.preventDefault();
